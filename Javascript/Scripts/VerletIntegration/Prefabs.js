let Prefabs = {
    ...
    Box: function (verlet, x, y, width, height, rotationDegrees, collides, stiffness, objectID) {
        ...
        let particle2 =
            new Particle({
                vector: new Vector2D(
                    rotatePoint(x, y, x + width, y, rotationDegrees)[0],
                    rotatePoint(x, y, x + width, y, rotationDegrees)[1]),
                objectID: objectID
            });
        ...
        let particle3 =
            new Particle({
                vector: new Vector2D(
                    rotatePoint(x, y, x + width, y + height, rotationDegrees)[0],
                    rotatePoint(x, y, x + width, y + height, rotationDegrees)[1]),
                objectID: objectID
            });
        ...
        let particle4 =
            new Particle({
                vector: new Vector2D(
                    rotatePoint(x, y, x, y + height, rotationDegrees)[0],
                    rotatePoint(x, y, x, y + height, rotationDegrees)[1]),
                objectID: objectID
            });
